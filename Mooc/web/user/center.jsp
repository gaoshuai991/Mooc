...
<script src="js/gss.js" type="text/javascript"></script>
<script src="js/user/center.js" type="text/javascript"></script>
<title>慕课答疑平台</title>
</head>
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal col-sm-offset-3" id="updateform" method="post" action="user!update.action">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="input-group date form_datetime" data-date-format="dd-MM-yyyy" data-link-field="dtp_input1">
	                    <input class="form-control" size="16" type="text" name="user.birthday" id="user.birthday" readonly>
